...
export const ENV = {
    ...
    TOKEN_WATCH_INTERVAL_MS: Number(process.env.TOKEN_WATCH_INTERVAL_MS ?? 10_000),
    MIN_TOKEN_MARKETCAP_USD: Number(process.env.MIN_TOKEN_MARKETCAP_USD ?? 300000),
    MIN_TOKEN_LIQUIDITY_USD: Number(process.env.MIN_TOKEN_LIQUIDITY_USD ?? 5000),
    POSITION_MONITOR_INTERVAL_MS: Number(process.env.POSITION_MONITOR_INTERVAL_MS ?? 5000),
